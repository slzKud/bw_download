<?php include_once $_SERVER['DOCUMENT_ROOT'].'/module/mysqlaction.php'; ?>
	...
	<?php
	 if(getthesettings("opensh")==="1"){
		 if ($nowpageid==6){
			 echo '<li class="active" ><a href="admituser.php"><span class="glyphicon glyphicon-user"></span> 注册审核</a></li>';
		 }else{
			 echo '<li ><a href="admituser.php"><span class="glyphicon glyphicon-user"></span> 注册审核</a></li>';
		 }
